...
# Add parent directory to path (assuming ultimate_ensemblev3.py is there)
...
def main():
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_val_acc:
            ...
            save_path = os.path.join(os.path.dirname(train_dir), "ultimate_ensemble_v3.pth")
